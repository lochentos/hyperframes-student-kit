...
hour of takes in a tenth the tokens of raw JSON and gives word-boundary
precision from text alone.
...
def group_into_phrases(words: list[dict], silence_threshold: float = 0.5) -> list[dict]:
    """Walk a word list, break into phrases on silence >= threshold OR speaker change."""
    phrases: list[dict] = []
